...
namespace Eleave.Data
{
    public class GetCommentApprover : MsSQL
    {
        ...
        public List<ApproveCommentRequest> GetComment(string ReqNo)
        {
            ...
            var table = GetData(CmdStore("P_Get_Comment_Detail", p));
            return ConvertExtension.ConvertDataTable<ApproveCommentRequest>(GetData(CmdStore("P_Get_Comment_Detail", p)));
        }
    }
}
